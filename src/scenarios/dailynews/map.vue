...
<script setup>
import Timeline from "@/scenarios/dailynews/timeline.vue";
import earthFootprint from "@/scenarios/dailynews/earthFootprint.vue";
import cardFootprint from "@/scenarios/dailynews/cardFootprint.vue";
